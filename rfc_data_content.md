...
- **Network Code**: The network should represent a physical or logical network. A mine or mining complex can include multiple networks. The network name should be compact but be easily recognized and understood. For instance, the Oyu Tolgoi
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjE1MzQwNTExLDEzMzkzNTAxMywtMjE0NT
